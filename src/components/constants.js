...
export const buttonUpdate = document.querySelector('.button_action_update');
export const formUpdate = document.querySelector('.popup__form_action_update');
...
export const inputAbout = popupEditProfile.querySelector('.popup__input_profile_about');
